...
float32_t signalStandardDeviation(float32_t sigVariance);
...
int main(){
	...
	//	inputStandardDeviation = signalStandardDeviation((float32_t)inputVariance);
	arm_std_f32(&inputSignal_f32_1kHz_15kHz[0], SIG_LENGTH , &inputStandardDeviation);
